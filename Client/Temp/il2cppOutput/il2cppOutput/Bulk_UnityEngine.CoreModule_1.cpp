...
extern "C" IL2CPP_METHOD_ATTR float Vector2_SignedAngle_m1664554214 (RuntimeObject * __this /* static, unused */, Vector2_t2156229523  ___from0, Vector2_t2156229523  ___to1, const RuntimeMethod* method)
{
	...
	float V_2 = 0.0f;
	{
		Vector2_t2156229523  L_0 = ___from0;
		Vector2_t2156229523  L_1 = ___to1;
		IL2CPP_RUNTIME_CLASS_INIT(Vector2_t2156229523_il2cpp_TypeInfo_var);
		float L_2 = Vector2_Angle_m4105581454(NULL /*static, unused*/, L_0, L_1, /*hidden argument*/NULL);
		V_0 = L_2;
		...
		IL2CPP_RUNTIME_CLASS_INIT(Mathf_t3464937446_il2cpp_TypeInfo_var);
		float L_7 = Mathf_Sign_m3457838305(NULL /*static, unused*/, ((float)il2cpp_codegen_subtract((float)((float)il2cpp_codegen_multiply((float)L_3, (float)L_4)), (float)((float)il2cpp_codegen_multiply((float)L_5, (float)L_6)))), /*hidden argument*/NULL);
		V_1 = L_7;
		float L_8 = V_0;
		float L_9 = V_1;
